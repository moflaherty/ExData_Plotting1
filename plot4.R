...
with (data, {
  plot(dateTimes, data$Global_active_power, xlab='', ylab='Global Active Power', 
       type='n')
  lines(dateTimes, data$Global_active_power)
  
  plot(dateTimes, data$Voltage, xlab='datetime', ylab='Voltage', 
       type='n')
  ...
  plot(dateTimes, data$Global_reactive_power, xlab='datetime', ylab='Global_reactive_power', 
       type='n')
